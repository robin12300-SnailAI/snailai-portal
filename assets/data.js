    ...
    modules: [
      {
        title: "模块一 · AI 认知觉醒",
        lessons: [
          { id: "l01", title: "第 1 堂课 — 开营日：认识你的 AI 助手", desc: "龙虾(WorkBuddy)介绍、MCP与自定义技能、如何对话、个人AI刚需确定、学员刚需项目启动、注册 GitHub 账户、课后作业（连上 email/drive 等）", duration: "120 min", slides: [], materialsTitle: "20260707 课件链接", materials: [
        ...
        lessons: [
          { id: "l03", title: "第 3 堂课", desc: "技能开发实战：生成 WorkBuddy 技能 + GitHub 随改推送与回滚，三大专家协同，AI 刚需项目启动，AI 能力清单应用", duration: "120 min", slides: [], materials: [],
            chapters: [
              ...
              "AI 刚需项目启动推进：调用同步修改技能，开发工程师打头炮、数据工程师建后端、UI 建前端，生成 GitHub Page 浏览并持续迭代",
              "AI 能力清单的使用（与助教一起）",
      ...
      },
      {
        title: "模块三 · 生活场景应用",
        lessons: [
          { id: "l07", title: "第 7 堂课", desc: "待定", duration: "120 min", slides: [], materials: [], chapters: [] },
          { id: "l08", title: "第 8 堂课", desc: "待定", duration: "120 min", slides: [], materials: [], chapters: [] },
          { id: "l09", title: "第 9 堂课", desc: "待定", duration: "120 min", slides: [], materials: [], chapters: [] }
        ]
      },
      {
        title: "模块四 · 总结与下一步",
        lessons: [
          { id: "l10", title: "第 10 堂课 — 结营日", desc: "回顾核心方法、建立你的 AI 工作流、中级预告", duration: "120 min", slides: [], materials: [], chapters: [] }
        ]
      }
    ]
  },
    ...
    modules: [
      {
        title: "模块一 · AI 投资认知",
        lessons: [
          { id: "l01", title: "第 1 堂课 — AI 时代的唯一入口", desc: "登录 Snailai.ai 填写你的第一个 AI 刚需、如何讲专业的 AI 提示词（阿拉丁神灯咒语）、自定义技能入门（我的购买清单）、API 登录蜗牛 AI 官网学生账号、建立 AI 时代唯一入口的认知", duration: "120 min", slides: [], materialsTitle: "20260711 课件链接", materials: [
            { name: "线下课课件总结 20260711（Word）", file: "lesson/l01/线下课课件总结 20260711.docx" }
          ],
            chapters: [
          ...
          { id: "l02", title: "第 2 堂课", desc: "腾讯熊猫、学员 AI 项目展示与 workbuddy 之歌", duration: "120 min", slides: [], materials: [], chapters: ["腾讯熊猫-你的AI 第二大脑", "学员展示 AI 项目设立", "workbuddy 之歌"] }
        ]
      },
      {
        title: "模块二 · AI 分析实战",
        lessons: [
          { id: "l03", title: "第 3 堂课", desc: "搭建自动化部署工作流：企业微信通知、Cloudflare 注册域名、Render 租用远程主机服务", duration: "120 min", slides: [], materials: [], chapters: ["企业微信通知", "Cloudflare 注册域名", "Render 租用远程主机服务", "你的日程和任务"] },
      ...
      },
      {
        title: "模块三 · AI 工作流搭建",
        lessons: [
          { id: "l06", title: "第 6 堂课", desc: "待生成", duration: "120 min", slides: [], materials: [], chapters: ["待生成"] },
          { id: "l07", title: "第 7 堂课", desc: "待生成", duration: "120 min", slides: [], materials: [], chapters: ["待生成"] }
        ]
      },
      {
        title: "模块四 · 综合与结营",
        lessons: [
          { id: "l08", title: "第 8 堂课", desc: "待生成", duration: "120 min", slides: [], materials: [], chapters: ["待生成"] },
          { id: "l09", title: "第 9 堂课", desc: "待生成", duration: "120 min", slides: [], materials: [], chapters: ["待生成"] }
        ]
      }
    ]
  }
